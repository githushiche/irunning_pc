 ...
 * Vesion:1.0
 */
public class DetailsDynamicAdapter extends RecyclerView.Adapter<DetailsDynamicAdapter.ViewHolder> {
    private final String TAG = "DetailsDynamicAdapter";
    ...
    public DetailsDynamicAdapter(List<Dynamic> dynamics) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        // 加载头像
        holder.mIvDynamicUserImg.setImageBitmap(FriendDetailsDialog.sFriendBitmap);
        // 加载配图
        Glide.with(mContext)
