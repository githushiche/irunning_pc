package com.example.hsc.irunning.stepcount.service;
...
import com.example.hsc.irunning.stepcount.adapter.Constant;
...
public class StepService extends Service implements SensorEventListener {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        /**
         * 此处设将Service为前台，不然当APP结束以后很容易被GC给干掉，这也就是大多数音乐播放器会在状态栏设置一个 原理大都是相通的
         */
         ...
         * 再来确定跳转页面，这里面太多坑，（别问我为什么知道 - -） 总之有需要的可以和我交流
         */
