...
public class RecordsCalenderItemView extends RelativeLayout {
    ...
    public RecordsCalenderItemView(Context context, String week, String date,
                                   int position, String curItemDate) {
        super(context);
    ...
    private void init() {
        ...
        final View itemView = inflater.inflate(
                R.layout.activity_main_step_item_view, this);
        itemLl = (LinearLayout) itemView
                .findViewById(R.id.records_calender_item_ll);
        weekTv = (TextView) itemView
                .findViewById(R.id.records_calender_item_week_tv);
        lineView = itemView.findViewById(R.id.calendar_item_line_view);
        dateRl = (RelativeLayout) itemView
                .findViewById(R.id.records_calender_item_date_rl);
        dateTv = (TextView) itemView
                .findViewById(R.id.records_calender_item_date_tv);
        ...
        itemView.setLayoutParams(new LayoutParams(
                (StepMainActivity.screenWidth) / 7,
    ...
    public void setChecked(boolean checkedFlag) {
        ...
        if (checkedFlag) {
            // 当前item被选中后样式
            weekTv.setTextColor(getResources()
            ...
            // 当前item未被选中样式
            weekTv.setTextColor(getResources().getColor(
                    R.color.gray_default_dark));
            dateTv.setTextColor(getResources().getColor(
                    R.color.gray_default_dark));
            // 设置背景透明
